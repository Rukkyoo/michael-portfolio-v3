...
const FooterBar = () => {
  return (
    <div className="px-20 w-full pt-20 pb-10 text-white" id="contact">
      ...
      <div className="flex flex-col items-center">
        ...
        <p className="text-white-200 md:mt-10 my-5 text-center">
          Reach out to me today and we&apos;ll discuss how I can help you reach
          your goal
        </p>
        <a href="mailto:Michaelomoneddo001@gmail.com">
          <MagicButton
